			...
			<div class="col py-3">
				...
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-10">
							<form class="row g-3 shadow p-3 rounded-2" action="/addstudent" method="post">
								...
								<div class="col-md-6">
									<label for="inputPassword4" class="form-label">Mother
										...
										id="inputPassword4" name="mother_name">
								</div>
								<div class="col-12">
								...
								<div class="col-md-6">
									<label for="inputPassword4" class="form-label">Blood
										...
										id="inputPassword4" name="blood_group">
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<label for="id" class="form-label">Department code</label>
								<select name="departmentcode" class="form-select" aria-label="Default select example" id="id">
									<c:forEach var="d" items="${de}">
									<option >${d.departmentcode}</option>
									</c:forEach>
